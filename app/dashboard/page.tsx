  ...
  return (
    <div className="flex-1 p-8 lg:p-12 overflow-y-auto w-full text-black">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        ...
        <div className="bg-black text-white p-8 border-4 border-black shadow-[8px_8px_0px_0px_rgba(232,252,59,1)] flex flex-col justify-between h-48 group hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[12px_12px_0px_0px_rgba(232,252,59,1)] transition-all cursor-crosshair">
