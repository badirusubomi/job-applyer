  ...
  return (
    <div className="flex-1 p-8 lg:p-12 overflow-y-auto w-full text-black">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div className="bg-white p-8 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col justify-between h-48 group hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all cursor-crosshair">
        ...
        <div className="bg-black text-white p-8 border-4 border-black shadow-[8px_8px_0px_0px_rgba(232,252,59,1)] flex flex-col justify-between h-48 group hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[12px_12px_0px_0px_rgba(232,252,59,1)] transition-all cursor-crosshair relative overflow-hidden">
      ...
      <div className="bg-white border-4 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
          <Link href="/job-watcher" className="px-8 py-4 bg-[#e8fc3b] text-black border-2 border-black font-bold uppercase tracking-wider text-center hover:bg-black hover:text-[#e8fc3b] transition-colors relative group">
            <span className="relative z-10">Scan Network</span>
          ...
          <Link href="/profile-editor" className="px-8 py-4 bg-white text-black border-2 border-black font-bold uppercase tracking-wider text-center hover:bg-black hover:text-white transition-colors relative group">
            <span className="relative z-10">Inject Profile</span>
            <div className="absolute inset-0 bg-black translate-x-1 translate-y-1 -z-10 group-hover:translate-x-0 group-hover:translate-y-0 transition-transform"></div>
          </Link>
        </div>
      </div>
